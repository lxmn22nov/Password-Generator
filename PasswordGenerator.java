...
public class PasswordGenerator {
      //character pools.
      //these strings will hold the char/numbers/symbols that we are going to randomly pick to generate our password.
      ...
      //includeUppercase and etc... considers if the paddword should include uppercase, lowercase, etc...(taken from the user).
      public String generatePassword(int length, boolean includeUppercase, boolean includeLowercase, boolean includeNumbers,boolean includeSpecialSymbols){
            //we'll use string builder over string for better efficiency.
